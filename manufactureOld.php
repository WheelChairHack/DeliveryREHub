...
function deleteProductionItem($item_id, $company_id) {
    // Подключение к базе данных
    $servername = "localhost"; // Имя сервера
    $username = "root"; // Имя пользователя базы данных
    $password = ""; // Пароль базы данных
    ...
    $sql = "DELETE FROM ProductionItems WHERE ItemID = ? AND CompanyID = ?";
...
if(isset($_POST['deleteProduct'])) {
    ...
    $result = deleteProductionItem($item_id, $company_id);
}
...
// Функция для добавления нового маршрута в базу данных
